...
// 清除行尾空格
// document.getElementById("noSpace").addEventListener("click", noSpace);
function noSpace() {
...
// 删除空行
// document.getElementById("noEmptyLines").addEventListener("click", noEmptyLines);
...
// 清空
document.getElementById("removeAllText").addEventListener("click", removeAllText);
